...
function pwaforwp_custom_add_to_home_callback(){
	...
	<p><?php echo esc_html__('Show custom responsive add to home banner popup', 'pwa-for-wp'); ?></p>
		...
		<div class="pwaforwp-enable-on-ios">
            <input type="checkbox" name="pwaforwp_settings[enable_add_to_home_ios_setting]" id="enable_add_to_home_ios_setting" class="" <?php echo (isset( $settings['enable_add_to_home_ios_setting'] ) &&  $settings['enable_add_to_home_ios_setting'] == 1 ? 'checked="checked"' : ''); ?> value="1"><strong><?php echo esc_html__('Enable On iOS', 'pwa-for-wp'); ?></strong>
        ...
        <div class="pwaforwp-enable-on-desktop">
            ...
            <p><?php echo esc_html__('Note: By default pop up will appear on android mobile device, to appear on io and desktop check there enable option', 'pwa-for-wp'); ?></p>
        </div>
        <?php }else{ ?>
        <div class="afw_hide pwaforwp-enable-on-desktop"><input type="checkbox" name="pwaforwp_settings[enable_add_to_home_desktop_setting]" id="enable_add_to_home_desktop_setting" class="" <?php echo (isset( $settings['enable_add_to_home_desktop_setting'] ) &&  $settings['enable_add_to_home_desktop_setting'] == 1 ? 'checked="checked"' : ''); ?> value="1"><strong><?php echo esc_html__('Enable On Desktop', 'pwa-for-wp'); ?></strong>
            <p><?php echo esc_html__('Note: By default pop up will appear on android mobile device, to appear on ios and desktop check there enable option', 'pwa-for-wp'); ?></p>
        </div>
        <?php }
