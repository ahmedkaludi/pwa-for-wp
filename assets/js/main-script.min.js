...
jQuery(document).ready(function($){
    ...
    $(document).on("click",".pwaforwp_license_activation", function(e){
        ...
        //Extenstion js starts here
        
        $('#pwaforwp-ext-tab a:first').addClass('pwaforwp-ext-selected');
        $('.pwaforwp-ext-container').hide();
        $('.pwaforwp-ext-container:first').show();
        
        $('#pwaforwp-ext-tab a').click(function(){
            
          var t = $(this).attr('data-id');
            
          if(!$(this).hasClass('pwaforwp-ext-selected')){
              
            $('#pwaforwp-ext-tab a').removeClass('pwaforwp-ext-selected');           
            $(this).addClass('pwaforwp-ext-selected');
