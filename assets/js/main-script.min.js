...
var pwaforwp_showpopup = function(caption, inlineId, submitClass){
    ...
    function onpwaiosOptSelection(e){
        ...
        if(selected=='generate-auto'){
            document.getElementById(selected+'-1').setAttribute("class", "accordion active");
            document.getElementById(selected+'-2').setAttribute("class", "panel");
            document.getElementById('manually-1').setAttribute("class", "accordion pwaforwp-hide");
            document.getElementById('manually-2').setAttribute("class", "panel pwaforwp-hide");
        }else{
            document.getElementById(selected+'-1').setAttribute("class", "accordion active");
            document.getElementById(selected+'-2').setAttribute("class", "panel");
            document.getElementById('generate-auto-1').setAttribute("class", "accordion pwaforwp-hide");
            document.getElementById('generate-auto-2').setAttribute("class", "panel pwaforwp-hide");
        }
    }
    var image='';
    ...
    function pwa_getimageZip(e){
        ...
        imageMessage.innerHTML = 'Please Wait...';
        ...
        Object.keys(pwaforwp_obj.iosSplashIcon).forEach(function(key, index) {
            ...
            var ws=phone['device-width'].replace("px", "");
            var hs=phone['device-height'].replace("px", "");
            canvas.width=ws;
            canvas.height=hs;
            var wi=img.width;
            var hi=img.height;
            ...
            request.onreadystatechange = function() {
                if (request.readyState === 4) {
                  ...
                  if(reponse.status==200){
                    imageMessage.innerHTML = 'images uploaded';
