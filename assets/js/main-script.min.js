...
function get_include_pages(){
    ...
    var data = {action:"pwaforwp_include_visibility_setting_callback",include_type:include_type};
    jQuery.ajax({
            url: ajaxurl,
            type: 'post',
            data: data,
...
function add_included_condition(){
    ...
    var data = {action:"pwaforwp_include_visibility_condition_callback",include_targeting_type:include_targeting_type,include_targeting_data:include_targeting_data};
    jQuery(".visibility-loader").css("display","flex");
    jQuery.ajax({
            url: ajaxurl,
            type: 'post',
...
function add_exclude_condition(){
    ...
    var data = {action:"pwaforwp_exclude_visibility_condition_callback",exclude_targeting_type:exclude_targeting_type,exclude_targeting_data:exclude_targeting_data};
    jQuery(".visibility-loader").css("display","flex");
    jQuery.ajax({
            url: ajaxurl,
            type: 'post',
