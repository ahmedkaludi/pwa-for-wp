...
jQuery("body").on('change','#custom_start_url_checkbox',function(e) { //Prefer Related Application
    if(jQuery(this).prop("checked")){
        jQuery('#js_custom_start_url').show();
        jQuery('#custom_start_url').prop('disabled',false);
    }else{
        jQuery('#js_custom_start_url').hide();
        jQuery('#custom_start_url').prop('disabled',true);
    }
});
